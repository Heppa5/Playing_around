...
int main(int argc, char** argv )
{
    ...
    Mat image1=imread("../test_images/0cm.jpg",1);
    ...
    vector< vector<Point2f> > markerCorners1; // So, the first corner is the top left corner, followed by the top right, bottom right and bottom left.
...
//     marker_3D.push_back(Point3f(0,0,0));
    ...
    marker_3D.push_back(Point3f(0,-0.169,0));
//     marker_3D.push_back(Point3f(0,0,0));
//     marker_3D.push_back(Point3f(0.18,0,0));
//     marker_3D.push_back(Point3f(0.18,0.18,0));
//     marker_3D.push_back(Point3f(0,0.18,0));
    ...
    Mat t=(tvec2-tvec);
    cout << norm(t) << endl;
    cout << "Euclidian distance: " << sqrt(pow(t.at<double>(0,0),2)+pow(t.at<double>(1,0),2)+pow(t.at<double>(2,0),2)) << endl;
