...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'testing_transformation_matrix' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/rovi2/catkin_ws/src/testing_transformation_matrix/${idir}'.  Ask the maintainer 'rovi2 <rovi2@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/rovi2/catkin_ws/src/testing_transformation_matrix/cmake-build-debug/devel/lib;/home/rovi2/catkin_ws/devel/lib;/opt/ros/kinetic/lib)
