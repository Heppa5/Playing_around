...
if("TRUE" STREQUAL "TRUE")
  set(testing_transformation_matrix_SOURCE_PREFIX /home/jepod13/catkin_ws/src/testing_transformation_matrix)
  set(testing_transformation_matrix_DEVEL_PREFIX /home/jepod13/catkin_ws/src/testing_transformation_matrix/cmake-build-debug/devel)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'testing_transformation_matrix' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'testing_transformation_matrix' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/jepod13/catkin_ws/src/testing_transformation_matrix/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/jepod13/catkin_ws/src/testing_transformation_matrix/cmake-build-debug/devel/lib;/home/jepod13/catkin_ws/devel/lib;/opt/ros/kinetic/lib)
