...
private:
    virtual bool set_suction(Plugin_RobWorkStudio::suctionCup::Request &req, Plugin_RobWorkStudio::suctionCup::Response &res);
    void reset_values();
    ...
    ros::NodeHandle nh_;
    int promille_correction=21;
    int timer_time_ms=10,update_time=100, update_time_counter=0;
